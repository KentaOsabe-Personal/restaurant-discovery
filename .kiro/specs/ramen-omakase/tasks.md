...
- [x] 3. ラーメンタブの起動導線と画面状態を既存体験へ統合する
- [x] 3.1 (P) ラーメンタブ専用のおまかせボタンを追加する
...
- [x] 3.2 ラーメンおまかせ開始時の App 状態遷移と結果反映を組み込む
...
- [x] 3.3 ラーメンおまかせ起点の再レコメンド状態を App で保持する
...
- [x] 3.4 ラーメンタブ固有の入力文言を既存検索 UI に注入する
...
- [x] 4. 検証と非回帰を固定する
- [x] 4.1 (P) ラーメンおまかせのフロントエンド挙動をテストで固定する
...
- [x] 4.2 (P) ラーメンおまかせのバックエンド挙動をテストで固定する
