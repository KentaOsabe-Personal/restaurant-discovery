...
- [x] 1. SearchInput コンポーネントの骨格実装
- [x] 1.1 Props 型とコンポーネントの基盤を確立する
...
- [x] 2. 入力値の制御と送信ロジックの実装
- [x] 2.1 テキスト入力の制御とボタン有効・無効制御を実装する
...
- [x] 4.3 ローディング状態とアクセシビリティのテストを書く
